...
public class PatientForm {
    ...
    public PatientForm ( final Patient patient ) {
        ...
        if ( null != patient.getBloodSugarMealBound() ) {
            setBloodSugarMealBound( patient.getBloodSugarMealBound() );
        }
        else {
            setBloodSugarMealBound( 140 ); // default value
        }

        if ( null != patient.getBloodSugarFastingBound() ) {
            setBloodSugarFastingBound( patient.getBloodSugarFastingBound() );
        }
        else {
    ...
    /** The blood sugar meal bound of the patient */
    private Integer     bloodSugarMealBound;

    /** The blood sugar fasting bound of the patient */
    ...
    /**
     * Get the blood sugar meal bound of the patient
     *
     * @return the blood sugar meal bound of the patient
     */
    ...
    /**
     * Set the blood sugar meal bound of the patient
     *
    ...
    /**
     * Get the blood sugar fasting bound of the patient
     *
     * @return the blood sugar fasting bound of the patient
     */
    ...
    /**
     * Set the blood sugar fasting bound of the patient
     *
