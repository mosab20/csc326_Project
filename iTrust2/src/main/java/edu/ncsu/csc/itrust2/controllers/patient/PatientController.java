...
public class PatientController {
     ...
     * @return The page the patient should see
     */
    @GetMapping ( "/patient/sugarLevels/addSugarLevelsForm" )
    @PreAuthorize ( "hasRole('ROLE_PATIENT')" )
    public String addSugarLevelsForm ( final Model model ) {
        return "/patient/sugarLevels/addSugarLevelsForm";
    }
     ...
     * @return The page the patient to view their food diary entries.
     */
    @GetMapping ( "/patient/sugarLevels/bloodSugarTable" )
    @PreAuthorize ( "hasRole('ROLE_PATIENT')" )
    public String viewBloodSugarTable ( final Model model ) {
        return "/patient/sugarLevels/bloodSugarTable";
    }
}
