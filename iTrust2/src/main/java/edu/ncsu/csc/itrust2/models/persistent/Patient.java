...
public class Patient extends DomainObject<Patient> implements Serializable {
    ...
    public Patient ( final PatientForm form ) throws ParseException {
        ...
        // Patient can't set their blood sugar bounds
        if ( form.getBloodSugarMealBound() != null ) {
            setBloodSugarMealBound( form.getBloodSugarMealBound() );
        }
        else {
            setBloodSugarMealBound( 140 ); // default value
        }

        if ( form.getBloodSugarFastingBound() != null ) {
            setBloodSugarFastingBound( form.getBloodSugarFastingBound() );
        }
        else {
            setBloodSugarFastingBound( 100 ); // default value
        }
    ...
    /**
     * Upper bound on patient's blood sugar levels after eating
     */
    private Integer      bloodSugarMealBound;

    /**
     * Upper bound on patient's blood sugar levels after fasting (waking up)
     */
    private Integer      bloodSugarFastingBound;
    ...
    /**
     * Gets the patient's bloodSugarMealBound
     *
     * @return the bloodSugarMealBound
     */
    public Integer getBloodSugarMealBound () {
        return bloodSugarMealBound;
    }

    /**
     * Sets the patient's bloodSugarMealBound
     *
     * @param bloodSugarMealBound
     *            the bloodSugarMealBound to set
     */
    public void setBloodSugarMealBound ( final Integer bloodSugarMealBound ) {
        this.bloodSugarMealBound = bloodSugarMealBound;
    }

    /**
     * Gets the patient's bloodSugarFastingBound
     *
     * @return the bloodSugarFastingBound
     */
    public Integer getBloodSugarFastingBound () {
        return bloodSugarFastingBound;
    }

    /**
     * Sets the patient's bloodSugarFastingBound
     *
     * @param bloodSugarFastingBound
     *            the bloodSugarFastingBound to set
     */
    public void setBloodSugarFastingBound ( final Integer bloodSugarFastingBound ) {
        this.bloodSugarFastingBound = bloodSugarFastingBound;
    }
