...
public enum TransactionType {
    ...
    /**
     * Patient views Glucose Test office visit
     */
    PATIENT_GLUCOSE_TEST_VIEW ( 2501, "Patient views Glucose Test office visit", true ),

    /**
     * Data from a Glucose Test is entered
     */
    GLUCOSE_TEST_RESULTS_CREATE ( 2502, "Data from a Glucose Test is entered", false ),

    /**
     * An HCP confirms a patient's glucose test results
     */
    HCP_CONFIRM_GLUCOSE_TEST_RESULTS ( 2503, "An HCP confirms a patient's glucose test results", false ),
    
    /**
     * HCP views a patient's blood sugar levels data
     */
    PATIENT_BLOOD_SUGAR_LEVELS_VIEWED ( 2402, "Views blood sugar levels data", false ),
    
    /**
     * HCP views a patient's blood sugar levels data
     */
    HCP_BLOOD_SUGAR_LEVELS_VIEWED ( 2403, "Views the blood sugar levels data of a patient", false ),
    
    /**
     * Patient enters their daily blood sugar levels
     */
    PATIENT_BLOOD_SUGAR_LEVELS_ENTERED ( 2401, "Enters the blood sugar levels for the day", true );
