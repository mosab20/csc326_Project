...
public class PatientTest {
    ...
    public void testPatientDateOfDeath () throws ParseException {
        ...
        form.setBloodSugarMealBound( 200 );
        form.setBloodSugarFastingBound( 150 );
        ...
        assertTrue( 200 == testPatient.getBloodSugarMealBound() );
        assertTrue( 150 == testPatient.getBloodSugarFastingBound() );
        ...
        assertEquals( testPatient.getBloodSugarMealBound(), pf2.getBloodSugarMealBound() );
        assertEquals( testPatient.getBloodSugarFastingBound(), pf2.getBloodSugarFastingBound() );
    ...
    /**
     * Tests to see that a patient saved with null limits has limits set to the
     * default values
     *
     * @throws ParseException
     */
    @Test
    public void testDefaultBloodSugarLimits () throws ParseException {
        final User patient2 = new User( "patientTestPatient2", "123456", Role.ROLE_PATIENT, 1 );
        patient2.save();
        final PatientForm form2 = new PatientForm();
        form2.setFirstName( "patient2" );
        form2.setPreferredName( "patient2" );
        form2.setLastName( "mcpatientface" );
        form2.setEmail( "bademail@ncsu.edu" );
        form2.setAddress1( "Some town" );
        form2.setAddress2( "Somewhere" );
        form2.setCity( "placecity" );
        form2.setState( State.AL.getName() );
        form2.setZip( "27606" );
        form2.setPhone( "111-111-1111" );
        form2.setDateOfBirth( "1901-01-01" ); // YYYY-MM-dd
        form2.setDateOfDeath( "2001-01-01" ); // YYYY-MM-dd
        form2.setCauseOfDeath( "Hit by a truck" );
        form2.setBloodType( BloodType.ABPos.getName() );
        form2.setEthnicity( Ethnicity.Asian.getName() );
        form2.setGender( Gender.Male.getName() );
        form2.setSelf( patient2.getUsername() );
        final Patient testPatient2 = new Patient( form2 );
        testPatient2.save();
        // test defaults
        assertTrue( 140 == testPatient2.getBloodSugarMealBound() );
        assertTrue( 100 == testPatient2.getBloodSugarFastingBound() );
    }
